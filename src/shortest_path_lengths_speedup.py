#attempt to speedup current shortest_lengths.py Script by moving to numpy
#matrices rather than using the Cython module

#write a function to find DeadShortestPaths
