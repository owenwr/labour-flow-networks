...
Municipalities 2016 (http://www.stat.fi/meta/luokitukset/kunta/001-2016/index_en.html)
020	Akaa
005	Alajärvi
009	Alavieska
010	Alavus
...
- Not sure what codes for kkunta or maak mean. Omar says info can be found on Statistics Finland website
- kkunta are for 2016. I checked and they differ (by 7 out of 320) from 2013. This strongly suggests that the kunta when the data was collected (2008??) were different again. We should therefore be wary about talking about actual regions. That is, we might as well call the regions by numbers than by their names since we don’t know what areas the names refer to at the time of data collection (although the 2016 values should provide a good approximation)